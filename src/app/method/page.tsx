...
import { ArrowLeft, Copy, FileText, Mail, MessageSquare, Download, Upload, Plus, Save, X } from "lucide-react";
...
// Duplicate legacy block removed (was causing "use client" mid-file)

// Duplicate component removed

// NOTE: The advanced MethodPage (with generator) was removed earlier. Keep only one page component.
